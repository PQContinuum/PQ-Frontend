...
const FALLBACK_PLAN_CONFIGS: PlanFeatureConfig[] = [
  {
    ...
    chat: { requestsPerMinute: 25, tokensPerDay: 100000, model: { model: 'xai/grok-4.1-fast-reasoning', label: 'Continuum Core', maxTokens: 16000 } },
  ...
  },
  {
    ...
    chat: { requestsPerMinute: 50, tokensPerDay: 350000, model: { model: 'xai/grok-4.1-fast-reasoning', label: 'Continuum Pro', maxTokens: 20000 } },
  ...
  },
  {
    ...
    chat: { requestsPerMinute: 75, tokensPerDay: 750000, model: { model: 'xai/grok-4.1-fast-reasoning', label: 'Continuum Pro', maxTokens: 20000 } },
  ...
  },
  {
    ...
    chat: { requestsPerMinute: 100, tokensPerDay: 1500000, model: { model: 'xai/grok-4.1-fast-reasoning', label: 'Continuum Pro', maxTokens: 20000 } },
