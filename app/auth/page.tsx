        ...
        <div className="rounded-2xl border border-black/5 bg-white p-8 shadow-xl">
          ...
          {message && (
            <motion.div
              initial={{ opacity: 0, y: -10 }}
              animate={{ opacity: 1, y: 0 }}
              className="mb-4 rounded-lg border border-orange-200 bg-orange-50 p-3 text-sm text-[#FF8B3D]"
            >
              {message}
            </motion.div>
          )}
          ...
          <form onSubmit={handleAuth} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  disabled={loading}
                  required
                  className="w-full rounded-lg border border-black/10 bg-white py-3 pl-11 pr-4 text-[#111111] placeholder:text-[#4c4c4c]/40 focus:border-[#FF8B3D] focus:outline-none focus:ring-2 focus:ring-[#FF8B3D]/20 disabled:cursor-not-allowed disabled:opacity-50"
                />
              </div>
            </div>
            ...
            <motion.button
              ...
              className="w-full rounded-lg bg-[#FF8B3D] py-3 font-semibold text-white transition-colors hover:bg-[#FF8B3D]/90 disabled:cursor-not-allowed disabled:opacity-50"
            >
              {loading ? (
