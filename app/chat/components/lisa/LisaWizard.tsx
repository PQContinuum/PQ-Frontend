              ...
              >
                <div
                  className={`w-8 h-8 rounded-full flex items-center justify-center transition-all ${
                    isActive
                      ? 'bg-[#FF8B3D] text-white shadow-lg shadow-[#FF8B3D]/30'
                      : isCompleted
                      ? 'bg-[#FF8B3D]/20 text-[#FF8B3D]'
        ...
        <div className="flex items-center justify-between">
          ...
          {isLastStep ? (
            ...
            <button
              onClick={nextStep}
              disabled={!canProceed()}
              className="flex items-center gap-1 px-5 py-2.5 bg-[#FF8B3D] text-white rounded-xl font-medium hover:bg-[#FF8B3D]/90 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Siguiente
