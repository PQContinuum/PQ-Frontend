    ...
    return (
      <span className="block w-full max-w-[560px] aspect-video rounded-2xl bg-gray-100 flex flex-col items-center justify-center gap-3">
        ...
        <button
          ...
          className="px-4 py-1.5 text-xs font-medium text-white bg-[#FF8B3D] hover:bg-[#00441f] rounded-lg transition-colors"
        >
          Reintentar
        </button>
      </span>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    ...
                    className="p-2 bg-[#FF8B3D]/80 hover:bg-[#FF8B3D] rounded-lg backdrop-blur-sm transition"
                  >
        ...
        >
          ...
          <span className="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-3">
            <button
              type="button"
              onClick={(e) => { e.stopPropagation(); setShowGalleryModal(true); }}
              className="flex items-center gap-2 px-4 py-2 bg-[#FF8B3D] rounded-full text-sm font-medium text-white hover:bg-[#00442b] transition shadow-lg"
            >
            ...
            <span className="block p-6 space-y-3">
              ...
              >
                <span className="flex items-center justify-center size-10 rounded-full bg-gray-200">
                  {copied ? (
                    <svg className="size-5 text-[#FF8B3D]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <div className="flex justify-start w-full">
        <div className="inline-flex max-w-full w-full rounded-4xl border border-transparent bg-transparent text-black px-4 py-2">
          <div className="space-y-6 w-full">
            {/* Header skeleton */}
            <div className="flex items-center gap-3 pb-4 border-b border-[#FF8B3D]/10 animate-pulse">
            ...
            <div className="space-y-6 animate-pulse">
              ...
              <div className="space-y-3">
                <div className="h-6 bg-gradient-to-r from-[#FF8B3D]/20 to-[#FF8B3D]/10 rounded w-2/5"></div>
              ...
              {/* Section 2 */}
              <div className="space-y-3">
                <div className="h-6 bg-gradient-to-r from-[#FF8B3D]/20 to-[#FF8B3D]/10 rounded w-1/3"></div>
                <div className="space-y-2">
                  <div className="h-4 bg-[#e8e8e8] rounded w-full"></div>
                  <div className="h-4 bg-[#e8e8e8] rounded w-10/12"></div>
                  <div className="h-4 bg-[#e8e8e8] rounded w-11/12"></div>
              ...
              <div className="flex items-center justify-center py-6">
                <div className="relative">
                  <div className="absolute inset-0 bg-[#FF8B3D]/10 rounded-full blur-xl animate-pulse"></div>
                  <svg className="size-12 text-[#FF8B3D]/20 relative animate-pulse" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              {/* Section 4 */}
              <div className="space-y-3">
                <div className="h-6 bg-gradient-to-r from-[#FF8B3D]/20 to-[#FF8B3D]/10 rounded w-1/2"></div>
                <div className="space-y-2">
                  <div className="h-4 bg-[#e8e8e8] rounded w-full"></div>
                  <div className="h-4 bg-[#e8e8e8] rounded w-11/12"></div>
                  <div className="h-4 bg-[#e8e8e8] rounded w-10/12"></div>
            ...
            {/* Footer skeleton */}
            <div className="pt-6 border-t border-[#FF8B3D]/10 animate-pulse">
      ...
      <div className="flex justify-start w-full">
        <div className="inline-flex max-w-full w-full rounded-4xl border border-transparent bg-transparent text-black px-4 py-2">
          <div className="w-full space-y-6">
            ...
            <div className="flex items-center gap-3 pb-4 border-b border-[#FF8B3D]/10">
              <div className="flex-shrink-0">
                <div className="size-12 rounded-full bg-gradient-to-br from-[#FF8B3D] to-[#d9753e] flex items-center justify-center shadow-lg">
              ...
              <div className="flex-1">
                <h3 className="text-xs font-semibold text-[#FF8B3D]/60 uppercase tracking-wider mb-1">
            ...
            {/* Footer decoration */}
            <div className="pt-6 border-t border-[#FF8B3D]/10">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2 text-xs text-[#FF8B3D]/40">
      ...
      <div className={`flex flex-col gap-1 min-w-0 ${isUser ? 'max-w-[85%] md:max-w-[75%]' : 'max-w-[90%] md:max-w-[80%]'}`}>
        <div
          className={`border overflow-hidden ${
            isUser
              ? 'rounded-4xl px-4 py-2 text-[15px] leading-relaxed border-transparent bg-[#FF8B3D] text-white font-medium'
