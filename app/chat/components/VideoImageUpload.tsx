  ...
  if (previewUrl && !isUploading) {
    return (
      <div className="relative group">
        <div className="relative w-12 h-12 rounded-lg overflow-hidden border-2 border-[#FF8B3D]/60 shadow-sm">
          <img
            src={previewUrl}
  ...
  return (
    ...
    >
      ...
      {isUploading ? (
        ...
        <ImagePlus className={`size-5 ${isDragging ? 'text-[#FF8B3D]' : 'text-gray-400'}`} />
      )}
    </div>
  );
}
