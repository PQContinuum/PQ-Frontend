                ...
                <div className="px-4 sm:px-6 md:px-8 pt-10 sm:pt-12 pb-6 sm:pb-8">
                  ...
                  >
                    {[
                      ...
                      >
                        <div className="flex-shrink-0 w-8 h-8 sm:w-10 sm:h-10 bg-[#FF8B3D]/10 rounded-full flex items-center justify-center">
                          <item.icon className="size-4 sm:size-5 text-[#FF8B3D]" />
                        </div>
                  ...
                  {address && (
                    ...
                    >
                      <div className="flex items-center gap-2 mb-2 sm:mb-3 flex-wrap">
                        <CheckCircle2 className="size-4 sm:size-5 text-[#FF8B3D]" />
                      ...
                      <div className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm">
                        {address.street && (
                          <div className="flex flex-wrap">
                            <span className="text-[#FF8B3D] font-medium">Calle: </span>
                        ...
                        {address.neighborhood && (
                          <div className="flex flex-wrap">
                            <span className="text-[#FF8B3D] font-medium">Colonia: </span>
                            <span className="text-gray-800 ml-1">{address.neighborhood}</span>
                          </div>
                        )}
                        {address.city && (
                          <div className="flex flex-wrap">
                            <span className="text-[#FF8B3D] font-medium">Ciudad: </span>
                            <span className="text-gray-800 ml-1">
                        ...
                        <div className="pt-1.5 sm:pt-2 border-t border-[#e8956a]">
                          <span className="text-[10px] sm:text-xs text-[#FF8B3D]">
                    ...
                    {!address && (
                      <>
                        <button
                          onClick={onAllow}
                          disabled={isLoading}
                          className="w-full bg-gradient-to-r from-[#FF8B3D] to-[#d9753e] text-white font-semibold py-3 sm:py-4 px-4 sm:px-6 rounded-xl sm:rounded-2xl hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
                        >
                          {isLoading ? (
